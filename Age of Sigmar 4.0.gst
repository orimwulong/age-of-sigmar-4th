...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="e51d-b1a3-75fc-dc3g" name="Age of Sigmar 4.0" revision="45" battleScribeVersion="2.03" type="gameSystem">
  <costTypes>
    ...
    <costType name="Force Category - Spearhead" id="515e-4330-9249-5bb6" defaultCostLimit="-1" hidden="true"/>
  </costTypes>
  <profileTypes>
  ...
  <forceEntries>
    ...
    <forceEntry name="Path to Glory: Freeform [UNOFFICIAL, WIP]" id="78a1-f6c2-71b8-270a" hidden="false" childForcesLabel="Regiments and Auxiliary" sortIndex="5">
      <categoryLinks>
    ...
    <forceEntry name="Spearhead" hidden="false" id="9869-1863-6874-0789" childForcesLabel="Regiment" sortIndex="6">
      <categoryLinks>
      ...
      <constraints>
        <constraint type="max" value="1" field="forces" scope="roster" shared="true" id="3301-3a7b-6ace-5371"/>
      </constraints>
      <costs>
        <cost name="pts" typeId="points" value="0"/>
        <cost name="Destiny Points" typeId="bc33-05f5-8d3f-af43" value="0"/>
        <cost name="Force Category - PTG" typeId="e63c-79ff-93ba-c5eb" value="0"/>
        <cost name="Force Category - GHB" typeId="de92-2099-fbf7-a156" value="0"/>
        <cost name="Force Category - Spearhead" typeId="515e-4330-9249-5bb6" value="1"/>
      </costs>
      <forceEntryLinks>
        <forceEntryLink name="Regiment" id="1b14-3512-e736-e5d1" hidden="false" targetId="376a-6b97-8699-dd59" type="forceEntry">
          <modifiers>
            <modifier type="set" value="false" field="hidden">
              <conditionGroups>
                <conditionGroup type="or">
                  <conditionGroups>
                    ...
                    <conditionGroup type="and">
                      <conditions>
                        <condition type="instanceOf" value="1" field="selections" scope="primary-catalogue" childId="b406-cce5-5518-e635" shared="true"/>
                        <condition type="instanceOf" value="1" field="selections" scope="parent" childId="b406-cce5-5518-e635" shared="true"/>
                      </conditions>
                    </conditionGroup>
                  </conditionGroups>
                </conditionGroup>
